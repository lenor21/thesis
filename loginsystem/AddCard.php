...
<body>
  <header >
    ...
    <button onclick="location.href='view.php'">Attendance Log</button>
  </header>
    ...
    <div class="opt">
        <form action="user_insert.php" method="POST" >
        	<table>
        		<tr>
        			<td>Name :</td>
        			<td><input type="text" placeholder="Full Name" name="Uname" required></td>
        		</tr>
        		<tr>
        			<td>Number :</td>
        			<td><input type="number" placeholder="Student Number" name="Number"></td>
        		</tr>
        		<tr>
        			<td>Gender :</td>
