...
const char *ssid = "HomeWifi"; //WIFI NAME OR HOTSPOT
const char *password = "apungmiling"; //WIFI PASSWORD POR MOBILE HOTSPOT PASSWORD
...
void sendRfidLog(long cardid) {
  ...
  if(WiFi.status() == WL_CONNECTED) {
    ...
    http.begin(wifiClient, "http://192.168.1.36/RFIDandPHP/process.php");              
